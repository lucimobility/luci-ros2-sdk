...
> _Note: Not all SLAM nodes need 2D and 3D data is definitely the better choice to use for LUCI if able_
...
As LUCI and wheelchairs operate with a left-right/forward-back joystick and most ROS2 packages expect a [Twist](https://docs.ros2.org/latest/api/geometry_msgs/msg/Twist.html) message a conversion node will be required.
